...
class Medical_History:
    def __init__(self, top=None):
        ...
        self.Label1.configure(width=674)
        ...
        self.Label2_1.configure(width=183)
        ...
        self.Label2_2.configure(width=163)
        ...
        self.Label2_5.configure(width=33)
        ...
        self.Label2_6.configure(width=103)

        self.Canvas1 = Canvas(top)
        self.Canvas1.place(relx=0.05, rely=0.3, relheight=0.619, relwidth=0.905)
        ...
        self.Canvas1.configure(width=543)

        def back():
            root.destroy()
            subprocess.call("python2 dashboard.py")

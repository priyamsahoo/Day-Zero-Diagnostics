...
class Dashboard___Student:
    def __init__(self, top=None):
        ...
        def history():
            root.destroy()
            subprocess.call("python2 medicalhistory_admin.py")
        ...
        self.Button1.configure(command = history)
        ...
        def fitbit():
            ...
            subprocess.call("python2 fitbit_graph.py")
        ...
        self.Button1_6.configure(command = fitbit)

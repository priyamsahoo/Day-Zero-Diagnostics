...
class Student_Dashboard___Services:
    def __init__(self, top=None):
        ...
        def logging_out():
            root.destroy()
            subprocess.call("python2 Gateway.py")
        ...
        def food():
            root.destroy()
            subprocess.call("python2 foodandexercise.py")
        ...
        def health():
            root.destroy()
            subprocess.call("python2 medicalhistory_student.py")
        ...
        def disease():
            root.destroy()
            subprocess.call("python2 diseasesandlabtests.py")
        ...
        def medi_redirect():
            root.destroy()
            subprocess.call("python2 studentdashboard.py")
